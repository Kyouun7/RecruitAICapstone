        ...
        <div>
          {job ? (
            <>
              ...
              <p className="text-on-surface-variant text-sm">Manage and review candidates for this position.</p>
              <div className="flex items-center flex-wrap gap-3 text-sm text-on-surface-variant mt-2">
