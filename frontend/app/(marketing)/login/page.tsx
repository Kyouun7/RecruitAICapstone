    ...
    <div className="flex-grow flex items-center justify-center px-4 py-6 min-h-[calc(100vh-72px)]">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10">
          ...
          <button disabled className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-lg text-on-surface-variant font-semibold text-sm opacity-50 cursor-not-allowed" title="Google login belum tersedia">
            ...
            <span>Google (belum tersedia)</span>
          </button>
