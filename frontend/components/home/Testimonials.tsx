  ...
  return (
    <section className="py-24 bg-primary text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <h2 className="text-4xl font-bold mb-16 text-center font-headline">Dipercaya oleh Para Pemimpin HR</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white/5 backdrop-blur-lg p-10 rounded-[2rem] border border-white/10">
            <span className="material-symbols-outlined text-5xl text-secondary-fixed mb-6" style={{ fontVariationSettings: "'FILL' 1" }}>format_quote</span>
            ...
            <div className="flex items-center gap-4">
              <img alt="Sarah Johnson" className="w-12 h-12 rounded-full object-cover"
          ...
          <div className="bg-white/5 backdrop-blur-lg p-10 rounded-[2rem] border border-white/10">
            ...
            <div className="flex items-center gap-4">
              <img alt="Michael Chen" className="w-12 h-12 rounded-full object-cover"
